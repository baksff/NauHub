...
function MainHold:Notify(text, discription, img)
   ...
   HolderFrame.Parent = game.CoreGui:FindFirstChild("NauHubNotify")
   ...
   PJMImageCorner.Name = "NauHubImageCorner"
   PJMImageCorner.Parent = PJMImage
   
   PJMTitle.Name = "NauHubTitle"
  ...
  MainFrame:Destroy()
    ...
    for i,v in pairs(game.CoreGui:FindFirstChild("NauHubNotify"):GetChildren()) do
        if not v:FindFirstChild("MainFrame") then
            v:Destroy()
        end
    end
    for i,v in pairs(game.CoreGui:GetChildren()) do
        if v.Name == "NauHubNotify" and not v:FindFirstChild("NauHubNotify") then
            v:Destroy()
        end
    end
